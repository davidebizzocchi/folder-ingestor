...
from qdrant_client.http.models import VectorStruct, ExtendedPointId
...
class VectorMemoryCollection:
    ...
    def recall_memories_from_embedding(
        ...
        langchain_documents_from_points: list[tuple[Document, float, "VectorStruct", "ExtendedPointId"]] = []
        for m in memories:
            m.vector
